...
(facts "User can change profile details, and fields are pre-filled"
       (-> (k/session test-app)
           ...
           (kc/check-page-is :show-change-profile-form [ks/change-profile-page-body])
           ...
           (kc/check-and-press ks/change-details-button)
           (kc/check-page-is :show-change-profile-form [ks/change-profile-page-body])
           ...
           (kc/check-and-follow-redirect)
           (kc/check-page-is :show-profile [ks/profile-page-body])
           (kc/selector-includes-content [ks/profile-flash-message] "profile")
           (kc/selector-includes-content [ks/profile-flash-message] "updated")
           (k/visit "/change-profile")
