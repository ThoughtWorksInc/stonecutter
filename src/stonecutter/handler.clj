  ...
  (let [profile-picture-store (storage/get-profile-picture-store stores-m)
    ...
    (->
      {:index                                user/index
       ...
       :show-change-profile-form             (partial user/show-change-profile-form user-store profile-picture-store)
       :change-profile                       (partial user/change-profile user-store profile-picture-store)
       ...
       :download-vcard                       (partial user/download-vcard user-store profile-picture-store)}
